  ...
  <div class="guide-card">
    ...
    <div class="guide-head">
      ...
      <div>
        ...
        <p class="guide-sub">Hanya isi halaman <em>Kelola Pesanan</em> — apa yang terlihat & apa yang bisa dipencet. Buka via tombol <em>Panduan</em> di bawah.</p>
      </div>
    </div>
    ...
    <ol class="guide-steps">
      <li data-keywords="buka panduan tombol"><span class="step-num">1</span><div><strong>Cara Buka Panduan Ini</strong> — Anda sedang di halaman <em>Kelola Pesanan</em>. Panduan ini dibuka via tombol <em>Panduan</em> di bar bawah (pill hitam, tombol ke-2). Tutup via <em>X</em> pojok, klik area gelap di luar, atau tekan <em>Esc</em>. Kotak pencari di atas bisa filter langkah (ketik: <em>pindah, pipeline, status, simpan</em>).</div></li>
      <li data-keywords="atas header progress pindah customer cari"><span class="step-num">2</span><div><strong>Bagian Atas — Yang Bisa Diklik</strong><br>• <em>Header kiri:</em> “Madu Wild Bee Admin” (judul). <em>Kanan:</em> chip nomor HP Anda (info) + tombol <em>bulan/matahari</em> ganti tema gelap/terang.<br>• <em>“3 DARI 8 TAHAP SELESAI”</em> + bar kuning — indikator progress, tidak bisa diklik.<br>• <em>Kartu “Pindah Customer”</em>: ketik <em>No HP / Email</em> di input → tekan <em>Buka</em> atau <em>Enter</em> untuk ganti customer yang dilihat tanpa kembali ke daftar. Teks bawah “Sedang melihat: …” info customer aktif.</div></li>
      <li data-keywords="pipeline 8 tahap klik lingkaran selesai dikerjakan ditunda"><span class="step-num">3</span><div><strong>Tengah — Pipeline 8 Tahap (Bisa Diklik Semua)</strong> — Baris horizontal 1 <em>Konsultasi</em> → 8 <em>Kesimpulan</em>. Klik <em>lingkaran angka/✓</em> atau label mana saja untuk membuka panel detail di bawah.<br>• <em>Hijau SELESAI</em> garis nyambung 100%<br>• <em>Orange DIKERJAKAN</em> garis setengah 50%<br>• <em>Abu DITUNDA</em> garis putus abu. Badge di bawah nama tahap menunjukkan status saat ini.</div></li>
      <li data-keywords="panel detail tutup status tanggung jawab tanggal upload bukti keterangan"><span class="step-num">4</span><div><strong>Panel Detail — Muncul Setelah Klik Tahap</strong> — Di PC muncul di bawah baris pipeline, di HP menempel persis di bawah kartu yang diklik.<br>• <em>Tutup ✕</em> pojok kanan untuk tutup.<br>• <em>Ubah Status:</em> 3 tombol <em>Selesai</em> (hijau) / <em>Dikerjakan</em> (orange) / <em>Ditunda</em> (abu) — klik salah satu, badge & warna lingkaran langsung berubah.<br>• <em>Tanggung Jawab:</em> dropdown Admin / Digital Marketing / Produksi.<br>• <em>Tanggal:</em> klik field → kalender.<br>• <em>Upload Bukti + Keterangan:</em> muncul hanya jika status <em>Selesai</em> (kecuali tahap 7 & 8) — pilih file JPG/PNG/PDF, isi keterangan opsional, link “Lihat bukti saat ini →” jika sudah ada. Tahap 8 ada field <em>Keterangan Kesimpulan</em> textarea.<br>• Panel 7 (Foto Video) jika Selesai akan ingatkan kirim WhatsApp.</div></li>
      <li data-keywords="bawah kelola customer simpan semua keluar"><span class="step-num">5</span><div><strong>Bar Bawah — 4 Tombol Tetap</strong> (pill bawah, 1 baris)<br>• <em>← Customer / Kelola Customer</em> (kiri) — ke halaman daftar customer.<br>• <em>Panduan</em> — buka panduan ini.<br>• <em>Simpan Semua</em> (kuning, tengah) — simpan SEMUA perubahan status/tanggal/upload sekaligus. Tunggu jadi “Menyimpan…” lalu notifikasi sukses.<br>• <em>Keluar</em> (kanan, dalam form) — logout. Semua tombol bisa dipencet kapan saja; Simpan wajib dipencet setelah ubah agar tersimpan.</div></li>
    </ol>
    <div class="guide-tip"><strong>Tips Klik:</strong> Di PC klik lingkaran mana saja → panel detail pindah ke bawah. Di HP klik <em>Lihat detail</em> di kartu vertikal → panel dropdown di bawah kartu, klik <em>Tutup</em> atau tahap lain untuk ganti. Semua perubahan warna langsung preview, tapi baru permanen setelah <em>Simpan Semua</em>.</div>
